(function () {
...
})()(
  {
    1: [
      ...
      {
        "./src/control-centers/talkify-controlcenter-classic.js": 2,
        "./src/control-centers/talkify-controlcenter-core.js": 3,
        "./src/control-centers/talkify-controlcenter-local.js": 4,
        "./src/control-centers/talkify-controlcenter-modern.js": 5,
        "./src/table-reader/talkify-tablereader.js": 6,
        "./src/talkify-ajax.js": 7,
        "./src/talkify-autoscroll.js": 8,
        "./src/talkify-config.js": 9,
        "./src/talkify-formreader.js": 10,
        "./src/talkify-html5-speechsynthesis-player.js": 11,
        "./src/talkify-keyboard-commands.js": 12,
        "./src/talkify-messagehub.js": 13,
        "./src/talkify-player-core.js": 14,
        "./src/talkify-player.js": 15,
        "./src/talkify-playlist.js": 16,
        "./src/talkify-speech-recognition.js": 17,
        "./src/talkify-text-selection-activator.js": 18,
        "./src/talkify-textextractor.js": 19,
        "./src/talkify-utils.js": 20,
        "./src/talkify-word-highlighter.js": 21,
        "./src/talkify.js": 22,
      },
    ],
    2: [
        ...
        talkify.playbar = function (parent, correlationId, controlcenter) {
          ...
          var settings = {
            parentElement:
              ...
              document.body,
            controlCenterName:
              controlcenter || talkify.config.ui.audioControls.controlcenter,
          };
          var playElement,
            pauseElement,
            rateElement,
          ...
          var attachElement,
            ...
            pitchElement,
            wordBreakElement,
            wordBreakElementWrapper;
          var pitchElementWrapper,
            nextItemElement,
            previousItemElement,
            voiceNameElement,
            enhancedVisibilityElement;
          var flagElement,
            phonationNormalElement,
            phonationSoftElement,
            phonationWhisperElement,
            phonationDropDown,
            downloadElement,
            downloadLoadingElement,
            downloadErrorElement;
          var voices = [];
          ...
          function createVoicePicker(voices, remoteVoices) {
            ...
            for (var prop in byLanguage) {
              ...
              var defaultVoice = remoteVoices
                ? sortedVoices.filter(function (x) {
                    return x.isStandard;
                  })[0]
                : sortedVoices.filter(function (x) {
              ...
              var mainFlag =
                ...
                mainCulture.split("-")[1].toLowerCase() +
                ".svg";
              ...
              label.innerHTML =
                sortedVoices[0].language || sortedVoices[0].lang;
              ...
              for (var j = 0; j < sortedVoices.length; j++) {
                ...
                innerLi.setAttribute(
                  "data-voice",
                  remoteVoices ? JSON.stringify(voice) : voice.name
                );
                ...
                var svg =
                  "https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.3.0/flags/4x3/" +
                  (voice.culture || voice.lang).split("-")[1].toLowerCase() +
                  ".svg";
          ...
          function render() {
            var existingControl = document.getElementsByClassName(
              "talkify-control-center"
            )[0];
            if (existingControl) {
              existingControl.parentNode.removeChild(existingControl);
            }
            var controlcenter = new talkify.controlcenters[
              settings.controlCenterName
            ]();
            ...
            playElement =
              wrapper.getElementsByClassName("talkify-play-button")[0] ||
              noopElement;
            pauseElement =
              wrapper.getElementsByClassName("talkify-pause-button")[0] ||
              noopElement;
            loader =
              wrapper.getElementsByClassName("talkify-audio-loading")[0] ||
              noopElement;
            erroroccurredElement =
              wrapper.getElementsByClassName("talkify-audio-error")[0] ||
              noopElement;
            rateElement =
              wrapper.querySelectorAll(
                ".talkify-rate-button input[type=range]"
              ) || [];
            volumeElement =
              wrapper.querySelectorAll(
                ".talkify-volume-button input[type=range]"
              ) || [];
            progressElement =
              wrapper.getElementsByTagName("progress")[0] || noopElement;
            textHighlightingElement =
              wrapper.getElementsByClassName("talkify-cc-button")[0] ||
              noopElement;
            currentTimeElement =
              wrapper.getElementsByClassName("talkify-time-element")[0] ||
              noopElement;
            detatchedElement =
              wrapper.getElementsByClassName("talkify-detatch-handle")[0] ||
              noopElement;
            attachElement =
              wrapper.getElementsByClassName("talkify-attach-handle")[0] ||
              noopElement;
            voiceWrapperElement =
              wrapper.querySelector(".talkify-voice-selector") || noopElement;
            dragArea =
              wrapper.getElementsByClassName("talkify-drag-area")[0] ||
              noopElement;
            textInteractionElement =
              wrapper.getElementsByClassName(
                "talkify-text-interaction-button"
              )[0] || noopElement;
            pitchElementWrapper =
              wrapper.querySelector(".talkify-pitch-element") || noopElement;
            pitchElement =
              pitchElementWrapper.getElementsByTagName("input")[0] ||
              noopElement;
            wordBreakElementWrapper =
              wrapper.querySelector(".talkify-wordbreak-element") ||
              noopElement;
            wordBreakElement =
              wordBreakElementWrapper.getElementsByTagName("input")[0] ||
              noopElement;
            flagElement =
              wrapper.getElementsByClassName(
                "talkify-selected-voice-flag"
              )[0] || noopElement;
            phonationDropDown =
              wrapper.querySelector(".talkify-phonation-element") ||
              noopElement;
            phonationWhisperElement =
              wrapper.querySelector("#talkify-phonation-whisper") ||
              noopElement;
            phonationSoftElement =
              wrapper.querySelector("#talkify-phonation-soft") || noopElement;
            phonationNormalElement =
              wrapper.querySelector("#talkify-phonation-normal") || noopElement;
            nextItemElement =
              wrapper.getElementsByClassName(
                "talkify-step-forward-button"
              )[0] || noopElement;
            previousItemElement =
              wrapper.getElementsByClassName(
                "talkify-step-backward-button"
              )[0] || noopElement;
            voiceNameElement =
              document.querySelector(".talkify-voice-selector span") ||
              noopElement;
            enhancedVisibilityElement =
              document.querySelector(".talkify-enhanced-visibility-button") ||
              noopElement;
            downloadElement =
              document.querySelectorAll(".talkify-download-button") || [];
            downloadLoadingElement =
              document.querySelectorAll(".talkify-download-loading") || [];
            downloadErrorElement =
              document.querySelectorAll(".talkify-download-error") || [];
            settings.parentElement.appendChild(wrapper);
          ...
          function setupBindings() {
            var controlCenter = document.getElementsByClassName(
              "talkify-control-center"
            )[0];
            playElement.addEventListener("click", function () {
              ...
              talkify.messageHub.publish(
                correlationId + ".controlcenter.request.play"
              );
            });
            pauseElement.addEventListener("click", function () {
              ...
              talkify.messageHub.publish(
                correlationId + ".controlcenter.request.pause"
              );
            });
            rateElement.forEach(function (x) {
              x.addEventListener("change", function () {
                talkify.messageHub.publish(
                  correlationId + ".controlcenter.request.rate",
            ...
            volumeElement.forEach(function (x) {
              x.addEventListener("change", function (e) {
                talkify.messageHub.publish(
                  correlationId + ".controlcenter.request.volume",
                  parseInt(this.value)
                );
              });
            });
            pitchElement.addEventListener("change", function () {
              talkify.messageHub.publish(
                correlationId + ".controlcenter.request.pitch",
                parseInt(this.value)
              );
            });
            wordBreakElement.addEventListener("change", function () {
              talkify.messageHub.publish(
                correlationId + ".controlcenter.request.wordbreak",
                parseInt(this.value)
              );
            });
            phonationDropDown.addEventListener("change", function () {
              if (this.value === "normal") {
                talkify.messageHub.publish(
                  correlationId + ".controlcenter.request.phonation.normal"
                );
              } else if (this.value === "soft") {
                talkify.messageHub.publish(
                  correlationId + ".controlcenter.request.phonation.soft"
                );
              } else if (this.value === "whisper") {
                talkify.messageHub.publish(
                  correlationId + ".controlcenter.request.phonation.whisper"
                );
              }
            });
            ...
            textHighlightingElement.addEventListener("click", function (e) {
              if (
                textHighlightingElement.classList.contains("talkify-disabled")
              ) {
                removeClass(textHighlightingElement, "talkify-disabled");
                talkify.messageHub.publish(
                  correlationId + ".controlcenter.texthighlightoggled",
                  true
                );
              } else {
            ...
            textInteractionElement.addEventListener("click", function (e) {
              if (
                textInteractionElement.classList.contains("talkify-disabled")
              ) {
                talkify.messageHub.publish(
                  correlationId +
                    ".controlcenter.request.textinteractiontoggled",
                  true
                );
              } else {
                talkify.messageHub.publish(
            ...
            enhancedVisibilityElement.addEventListener("click", function (e) {
              if (
                enhancedVisibilityElement.classList.contains("talkify-disabled")
              ) {
                talkify.messageHub.publish(
                  correlationId + ".controlcenter.request.enhancedvisibility",
                  true
                );
              } else {
                talkify.messageHub.publish(
            ...
            nextItemElement.addEventListener("click", function () {
              ...
              talkify.messageHub.publish(
                correlationId + ".controlcenter.request.playnext"
              );
            });
            previousItemElement.addEventListener("click", function () {
              ...
              talkify.messageHub.publish(
                correlationId + ".controlcenter.request.playprevious"
              );
            });
            progressElement.addEventListener("click", function (e) {
              ...
              talkify.messageHub.publish(
                correlationId + ".controlcenter.request.seek",
                clickedValue
              );
            });
            attachElement.addEventListener("click", function () {
              ...
              talkify.messageHub.publish(
                correlationId + ".controlcenter.attached",
                controlCenter.getBoundingClientRect()
              );
            });
            ...
            if (talkify.config.ui.audioControls.downloadEnabled) {
              downloadElement.forEach(function (x) {
                x.addEventListener("click", function () {
                  talkify.messageHub.publish(
                    correlationId + ".controlcenter.request.download"
                  );
                });
              });
            }
            ...
            function onMouseMove(e) {
              ...
              var leftOffset =
                dArea.width / 2 +
                dArea.x -
                controlCenter.getBoundingClientRect().x;
              controlCenter.style.top =
                e.clientY - controlCenter.offsetHeight / 2 + "px";
          ...
          function initialize() {
            ...
            talkify.messageHub.subscribe(
              "controlcenter",
              [
                correlationId + ".player.*.pause",
                correlationId + ".player.*.disposed",
                correlationId + ".player.html5.ended",
              ],
              pause
            );
            talkify.messageHub.subscribe(
              "controlcenter",
              [
                correlationId + ".player.*.play",
                correlationId + ".player.*.resume",
              ],
              play
            );
            talkify.messageHub.subscribe(
            ...
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".player.*.texthighlight.enabled",
              function () {
                removeClass(textHighlightingElement, "talkify-disabled");
              }
            );
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".player.*.texthighlight.disabled",
              function () {
                addClass(textHighlightingElement, "talkify-disabled");
              }
            );
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".player.*.ratechanged",
              function (rate) {
                rateElement.forEach(function (x) {
                  x.value = rate;
                });
            ...
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".player.tts.error",
              onError
            );
            talkify.messageHub.subscribe(
              "controlcenter",
            ...
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".player.html5.timeupdated",
              function (value) {
            ...
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".playlist.textinteraction.enabled",
              function () {
            ...
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".player.tts.download.started",
              function () {
                hide(downloadElement);
            ...
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".player.tts.download.completed",
              function () {
            ...
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".player.tts.download.error",
              function (obj) {
                hide(downloadLoadingElement);
            ...
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".player.*.pitchchanged",
              function (value) {
            ...
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".player.tts.phonationchanged",
              function (phonation) {
                phonationDropDown.value =
                  phonation === "soft" ? "soft" : "normal";
              }
            );
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".player.tts.whisperchanged",
              function (whisper) {
            ...
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".player.tts.created",
              function () {
                getRemoteVoices();
              }
            );
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".player.html5.created",
              function () {
            ...
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".player.*.enhancedvisibilityset",
              function (value) {
                if (value) {
            ...
            talkify.messageHub.subscribe(
              "controlcenter",
              correlationId + ".playlist.playing",
              function (msg) {
          ...
          function getLocalVoices() {
            ...
            setTimeout(function () {
              ...
              voicePicker = createVoicePicker(
                filterVoicesByConfig(voices),
                false
              );
              wrapper
                .getElementsByClassName("talkify-voice-selector")[0]
                .appendChild(voicePicker);
              voicePicker
                .querySelectorAll(".language > li")
                .forEach(function (item) {
                  item.addEventListener("click", function (e) {
                    var voice = voices.find(function (v) {
                      return v.name === e.currentTarget.dataset.voice;
                    });
                    talkify.messageHub.publish(
                      correlationId + ".controlcenter.request.setvoice",
                      voice
                    );
                  });
                });
          ...
          function getRemoteVoices() {
            talkify.http
              .get(talkify.config.remoteService.speechBaseUrl + "/voices")
              .then(function (data) {
                ...
                voicePicker
                  ...
                  .forEach(function (item) {
                    item.addEventListener("click", function (e) {
                      ...
                      talkify.messageHub.publish(
                        correlationId + ".controlcenter.request.setvoice",
                        window.talkify.toLowerCaseKeys(voice)
                      );
                    });
                  });
              });
          ...
          function filterVoicesByConfig(voices) {
            ...
            return voices.filter(function (voice) {
              ...
              if (filter.byCulture.length) {
                active =
                  filter.byCulture.indexOf(voice.culture || voice.lang) !== -1;
              }
              ...
              if (active && filter.byClass.length) {
                if (
                  filter.byClass.indexOf("Standard") !== -1 &&
                  voice.isStandard
                ) {
                  return true;
                }
                if (
                  filter.byClass.indexOf("Premium") !== -1 &&
                  voice.isPremium
                ) {
                  return true;
                }
                if (
                  filter.byClass.indexOf("Exclusive") !== -1 &&
                  voice.isExclusive
                ) {
                  return true;
                }
          ...
          function updateClock(timeInfo) {
            ...
            var totalseconds = !!duration
              ? Math.round(duration) - totalminutes * 60
              : 0;
          ...
          function featureToggle(voice) {
            ...
            voice.canUseWordBreak
              ? show(wordBreakElementWrapper)
              : hide(wordBreakElementWrapper);
            voice.canWhisper
              ? show(phonationWhisperElement)
              : hide(phonationWhisperElement);
            voice.canSpeakSoftly
              ? show(phonationSoftElement)
          ...
          function dispose() {
            ...
            talkify.messageHub.unsubscribe("controlcenter", [
              correlationId + ".player.*.pause",
              correlationId + ".player.*.disposed",
            ]);
            talkify.messageHub.unsubscribe("controlcenter", [
          ...
          function markTables(configurations) {
            for (var j = 0; j < configurations.length; j++) {
              ...
              for (var k = 0; k < config.tables.length; k++) {
                ...
                var headerCells =
                  getElements(config.headerCells) ||
                  table.querySelectorAll("th");
                var bodyCells =
                  getElements(config.bodyCells) || table.querySelectorAll("td");
      ...
      function (require, module, exports) {
        ...
        talkify.http = (function ajax() {
          var get = function (url) {
            var keypart =
              (url.indexOf("?") !== -1 ? "&key=" : "?key=") +
              talkify.config.remoteService.apiKey;
            return fetch(
              window.talkify.config.remoteService.host + url + keypart
            ).then(function (res) {
              return res.json();
            });
          };
            ...
            talkify.messageHub.subscribe(
              ...
              function (item) {
                var y =
                  ...
                  window.pageYOffset +
                  talkify.config.autoScroll.offsetpx;
        ...
        talkify.config = {
          ...
          ui: {
            audioControls: {
              ...
              voicepicker: {
                enabled: true,
                filter: { byClass: [], byCulture: [], byLanguage: [] },
              },
            },
          },
          formReader: {
          ...
          keyboardCommands: {
            enabled: false,
            commands: { playPause: 32, next: 39, previous: 37 },
          },
          voiceCommands: {
            enabled: false,
            keyboardActivation: { enabled: true, key: 77 },
            commands: {
        ...
        talkify.formReader = (function () {
          ...
          function onFocus(e) {
            ...
            timeout = setTimeout(function () {
              if (!player) {
                player = talkify.config.formReader.remoteService
                  ? new talkify.TtsPlayer()
                  : new talkify.Html5Player();
              }
              ...
              var requiredText = me.attributes.required
                ? config.requiredText
                : "";
              var label = findLabelFor(me);
              var text =
                getTextForCheckboxes(me, label) ||
                getTextForSelects(me, label) ||
                getTextForInputs(me, label) ||
                "";
      ...
      function (require, module, exports) {
        ...
        talkify.Html5Player = function () {
          ...
          this.audioSource = {
            play: function () {
              if (me.currentContext.item) {
                ...
                talkify.messageHub.publish(
                  me.correlationId + ".player.html5.unplayable"
                );
              }
            },
            pause: function () {
              ...
              talkify.messageHub.publish(
                me.correlationId + ".player.html5.pause"
              );
            },
            ended: function () {
            ...
            dispose: function () {
              talkify.messageHub.unsubscribe(
                "html5player",
                me.correlationId + ".controlcenter.request.play"
              );
              talkify.messageHub.unsubscribe(
                "html5player",
                me.correlationId + ".controlcenter.request.pause"
              );
              talkify.messageHub.unsubscribe(
                "html5player",
                me.correlationId + ".controlcenter.request.volume"
              );
              talkify.messageHub.unsubscribe(
                "html5player",
                me.correlationId + ".controlcenter.request.rate"
              );
              talkify.messageHub.unsubscribe(
                "html5player",
                me.correlationId + ".controlcenter.request.pitch"
              );
              if (timeupdater) {
          ...
          this.usePitch = function (pitch) {
            me.pitch = pitch;
            talkify.messageHub.publish(
              me.correlationId + ".player.html5.pitchchanged",
              pitch
            );
            return this;
          };
          ...
          talkify.messageHub.subscribe(
            ...
            function (rate) {
              ...
              talkify.messageHub.publish(
                me.correlationId + ".player.html5.ratechanged",
                rate
              );
            }
          );
          ...
          function playCurrentContext() {
            ...
            chuncks.forEach(function (chunck) {
              ...
              utterance.lang =
                me.settings.lockedLanguage ||
                me.settings.referenceLanguage.Culture;
            ...
            me.currentContext.utterances[
              me.currentContext.utterances.length - 1
            ].onend = function (e) {
              talkify.messageHub.publish(
                me.correlationId + ".player.html5.utterancecomplete",
                item
              );
              if (timeupdater) {
                clearInterval(timeupdater);
              ...
              if (
                me.currentContext.currentUtterance.text !== e.currentTarget.text
              ) {
                return;
              }
              if (!me.isStopped) {
                talkify.messageHub.publish(
                  me.correlationId + ".player.html5.ended",
                  item
                );
              }
            };
            me.currentContext.utterances.forEach(function (u, index) {
              if (index === 0) {
                u.onstart = function (e) {
                  ...
                  talkify.messageHub.publish(
                    me.correlationId + ".player.html5.loaded",
                    me.currentContext.item
                  );
                  talkify.messageHub.publish(
                    me.correlationId + ".player.html5.play",
                    {
                      item: me.currentContext.item,
                      positions: [],
                      currentTime: 0,
                    }
                  );
                  ...
                  timeupdater = setInterval(function () {
                    talkify.messageHub.publish(
                      me.correlationId + ".player.html5.timeupdated",
              ...
              getVoice().then(function (voice) {
                ...
                window.speechSynthesis.cancel();
                talkify.messageHub.publish(
                  me.correlationId + ".player.html5.voiceset",
                  voice
                );
          ...
          function chunckText(text) {
            ...
            sentences.forEach(function (sentence) {
              ...
              if (
                currentChunck &&
                currentChunck.length + sentence.length > chunckSize
              ) {
          ...
          function stop() {
            ...
            if (
              me.currentContext.utterances.indexOf(
                me.currentContext.currentUtterance
              ) <
              me.currentContext.utterances.length - 1
            ) {
          ...
          talkify.messageHub.publish(
            this.correlationId + ".player.html5.created"
          );
        };
        ...
        talkify.BasePlayer = function (_audiosource, _playbar, options) {
          ...
          if (talkify.config.ui.audioControls.enabled) {
            this.playbar.instance = talkify.playbar(
              options.controlcenter.container,
              this.correlationId,
              options.controlcenter.name
            );
          }
          talkify.messageHub.subscribe(
            "core-player",
          ...
          talkify.messageHub.subscribe(
            "core-player",
            this.correlationId + ".player.*.loaded",
            function (item) {
          ...
          talkify.messageHub.subscribe(
            "core-player",
            this.correlationId + ".player.*.ended",
            function (item) {
          ...
          talkify.messageHub.subscribe(
            "core-player",
            this.correlationId + ".controlcenter.texthighlightoggled",
            function (enabled) {
          ...
          talkify.messageHub.subscribe(
            "core-player",
            this.correlationId + ".controlcenter.request.setvoice",
            function (voice) {
              me.forceVoice(voice);
            }
          );
          talkify.messageHub.subscribe(
            "core-player",
            this.correlationId + ".controlcenter.request.enhancedvisibility",
            function (value) {
              talkify.messageHub.publish(
                me.correlationId + ".player.*.enhancedvisibilityset",
                value
              );
            }
          );
          talkify.messageHub.publish(
            this.correlationId + ".player.*.ratechanged",
            me.settings.rate
          );
          talkify.messageHub.publish(
            this.correlationId + ".player.*.enhancedvisibilityset",
            false
          );
          ...
          this.enableTextHighlighting = function () {
            ...
            talkify.messageHub.publish(
              this.correlationId + ".player.*.texthighlight.enabled"
            );
            return this;
          };
          this.disableTextHighlighting = function () {
            ...
            talkify.messageHub.publish(
              this.correlationId + ".player.*.texthighlight.disabled"
            );
            return this;
          };
          ...
          this.subscribeTo = function (subscriptions) {
            talkify.messageHub.subscribe(
              "core-player",
              this.correlationId + ".player.*.pause",
              subscriptions.onPause || function () {}
            );
            talkify.messageHub.subscribe(
              "core-player",
              this.correlationId + ".player.*.resume",
              subscriptions.onResume || function () {}
            );
            talkify.messageHub.subscribe(
              "core-player",
              this.correlationId + ".player.*.play",
              subscriptions.onPlay || function () {}
            );
            talkify.messageHub.subscribe(
              "core-player",
              this.correlationId + ".player.*.loaded",
              subscriptions.onItemLoaded || function () {}
            );
            talkify.messageHub.subscribe(
              "core-player",
              [
                this.correlationId + ".wordhighlighter.complete",
                this.correlationId + ".player.html5.utterancecomplete",
              ],
              subscriptions.onItemFinished || function () {}
            );
            talkify.messageHub.subscribe(
              "core-player",
              this.correlationId + ".player.*.prepareplay",
              subscriptions.onBeforeItemPlaying || function () {}
            );
            talkify.messageHub.subscribe(
              "core-player",
              this.correlationId + ".controlcenter.texthighlightoggled",
              subscriptions.onTextHighligtChanged || function () {}
            );
            return this;
          };
          ...
          this.createItems = function (text) {
            var safeMaxQuerystringLength =
              window.talkify.config.maximumTextLength || 1e3;
            var items = [];
            if (text.length > safeMaxQuerystringLength) {
              ...
              items = items.concat(
                this.createItems(
                  text.substr(safeMaxQuerystringLength, text.length - 1)
                )
              );
              return items;
            }
          ...
          this.dispose = function () {
            talkify.messageHub.publish(
              this.correlationId + ".player.tts.disposed"
            );
            ...
            talkify.messageHub.unsubscribe("core-player", [
              this.correlationId + ".wordhighlighter.complete",
              this.correlationId + ".player.html5.utterancecomplete",
            ]);
            talkify.messageHub.unsubscribe(
          ...
          this.forceVoice = function (voice) {
            ...
            this.settings.lockedLanguage =
              (voice && (voice.lang || voice.culture)) ||
              this.settings.lockedLanguage;
            talkify.messageHub.publish(
              this.correlationId + ".player.*.voiceset",
              voice
            );
            return this;
          };
    ...
    15: [
      function (require, module, exports) {
        ...
        talkify.TtsPlayer = function (options) {
          ...
          this.currentContext = { item: null, positions: [] };
          this.playbar = { instance: null };
          this.audioSource = {
            play: function () {
              audioElement.play();
            ...
            dispose: function () {
              ...
              talkify.messageHub.unsubscribe(
                "tts-player",
                me.correlationId + ".controlcenter.request.seek"
              );
              talkify.messageHub.unsubscribe(
                "tts-player",
                me.correlationId + ".controlcenter.request.volume"
              ...
              talkify.messageHub.unsubscribe(
                "tts-player",
                me.correlationId + ".controlcenter.request.wordbreak"
              );
              talkify.messageHub.unsubscribe(
                "tts-player",
                me.correlationId + ".controlcenter.request.pitch"
              ...
              talkify.messageHub.unsubscribe(
                "tts-player",
                me.correlationId + ".controlcenter.request.phonation.soft"
              );
              talkify.messageHub.unsubscribe(
                "tts-player",
                me.correlationId + ".controlcenter.request.phonation.whisper"
              );
            },
          };
          talkify.BasePlayer.call(
            this,
            this.audioSource,
            this.playbar,
            options
          ...
          function onSeek() {
            talkify.messageHub.publish(
              me.correlationId + ".player.tts.seeked",
              {
                time: this.currentTime,
                item: me.currentContext.item,
                positions: me.currentContext.positions,
              }
            );
          ...
          function onPlay() {
            ...
            timeupdater = setInterval(function () {
              talkify.messageHub.publish(
                me.correlationId + ".player.tts.timeupdated",
                {
            ...
            if (!me.currentContext.item) {
              talkify.messageHub.publish(
                me.correlationId + ".player.tts.unplayable"
              );
              me.audioSource.pause();
            }
            if (!me.currentContext.positions.length) {
              talkify.messageHub.publish(
                me.correlationId + ".player.tts.play",
                {
                  item: me.currentContext.item,
                  positions: [],
                  currentTime: me.audioSource.currentTime(),
                }
              );
              return;
            }
            if (me.audioSource.currentTime() > 0.1) {
              talkify.messageHub.publish(
                me.correlationId + ".player.tts.resume",
                { currentTime: me.audioSource.currentTime() }
              );
            } else {
          ...
          function initialize() {
            ...
            talkify.messageHub.subscribe(
              ...
              function (rate) {
                me.settings.rate = rate;
                talkify.messageHub.publish(
                  me.correlationId + ".player.tts.ratechanged",
                  me.settings.rate
                );
              }
            );
            ...
            talkify.messageHub.publish(
              this.correlationId + ".player.tts.created"
            );
          }
          function getPositions(requestId) {
            return talkify.http.get(
          ...
          this.downloadAudio = function (text) {
            ...
            xhr.onreadystatechange = function () {
              if (
                ...
                talkify.messageHub.publish(
                  me.correlationId + ".player.tts.download.error",
                  xhr
                );
              }
              if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                talkify.messageHub.publish(
                  me.correlationId + ".player.tts.download.completed",
                  null
                );
              }
            };
            ...
            talkify.messageHub.publish(
              me.correlationId + ".player.tts.download.started",
              null
            );
            xhr.send(data);
          };
          this.playAudio = function (item) {
            talkify.messageHub.publish(
              me.correlationId + ".player.tts.loading",
              item
            );
            me.currentContext.item = item;
            me.currentContext.positions = [];
            audioElement.controls =
              talkify.config.ui.audioControls.enabled &&
              talkify.config.ui.audioControls.controlcenter === "native";
            audioElement.onloadeddata = null;
            audioElement.onended = null;
            var sources = audioElement.getElementsByTagName("source");
            var textType =
              talkify.config.useSsml && item.ssml ? "ssml" : "text";
            var textToPlay =
              textType === "ssml"
                ? encodeURIComponent(item.ssml.replace(/\n/g, " "))
                : encodeURIComponent(item.text.replace(/\n/g, " "));
            var voice =
              item.voice || (this.forcedVoice ? this.forcedVoice.name : "");
            if (voice !== currentVoice) {
              talkify.messageHub.publish(
                this.correlationId + ".player.tts.voiceset",
                { name: voice }
              );
              currentVoice = voice;
            }
            ...
            if (pitch !== currentPitch) {
              talkify.messageHub.publish(
                me.correlationId + ".player.tts.pitchchanged",
                pitch
              );
              currentPitch = pitch;
            }
            ...
            if (wordbreak !== currentWordBreak) {
              talkify.messageHub.publish(
                me.correlationId + ".player.tts.wordbreakchanged",
                wordbreak
              );
            ...
            var audioUrl =
              ...
              textToPlay +
              "&fallbackLanguage=" +
              this.settings.referenceLanguage.Language +
              "&voice=" +
              voice +
              "&rate=" +
              rate +
              ...
              talkify.config.remoteService.apiKey +
              "&whisper=" +
              (item.whisper || this.settings.whisper) +
              "&soft=" +
              (item.soft || this.settings.soft) +
              "&wordbreakms=" +
              wordbreak +
              "&volume=" +
              this.settings.volumeDb +
              "&pitch=" +
              pitch;
            ...
            sources[1].onerror = function (e) {
              talkify.messageHub.publish(
                me.correlationId + ".player.tts.error",
                null
              );
            };
            audioElement.load();
            audioElement.onloadeddata = function () {
              ...
              if (!me.settings.useTextHighlight) {
                talkify.messageHub.publish(
                  me.correlationId + ".player.tts.loaded",
                  me.currentContext.item
                );
                me.audioSource.play();
                return;
            ...
            audioElement.onended = function () {
              talkify.messageHub.publish(
                me.correlationId + ".player.tts.ended",
                item
              );
            };
          };
          this.usePhonation = function (phonation) {
            ...
            talkify.messageHub.publish(
              me.correlationId + ".player.tts.phonationchanged",
              phonation
            );
            return this;
          };
          this.whisper = function () {
            ...
            talkify.messageHub.publish(
              me.correlationId + ".player.tts.whisperchanged",
              true
            );
            return this;
          };
          ...
          this.useVolumeBaseline = function (volumeDb) {
            ...
            talkify.messageHub.publish(
              me.correlationId + ".player.tts.volumechanged",
              volumeDb
            );
            return this;
          };
      ...
      function (require, module, exports) {
        ...
        talkify.playlist = function () {
          ...
          function implementation(_settings, player) {
            ...
            voiceCommands.onListeningStarted(
              settings.events.onVoiceCommandListeningStarted
            );
            voiceCommands.onListeningEnded(
              settings.events.onVoiceCommandListeningEnded
            );
            setupHubSubscribers();
            function setupHubSubscribers() {
              talkify.messageHub.subscribe(
                "playlist",
                player.correlationId + ".player.*.ended",
                function (endedItem) {
              ...
              talkify.messageHub.subscribe(
                "playlist",
                player.correlationId + ".player.*.unplayable",
                function () {
              ...
              talkify.messageHub.subscribe(
                "playlist",
                player.correlationId + ".controlcenter.request.playnext",
                playNext
              );
              talkify.messageHub.subscribe(
                "playlist",
                player.correlationId + ".controlcenter.request.playprevious",
                playPrevious
              );
              talkify.messageHub.subscribe(
                "playlist",
                player.correlationId + ".controlcenter.request.download",
                downloadAudio
              );
            }
            ...
            function playItem(item) {
              ...
              resetPlaybackStates();
              if (playlist.currentlyPlaying) {
                playlist.currentlyPlaying.element.innerHTML =
                  playlist.currentlyPlaying.originalElement.innerHTML;
              }
              playlist.currentlyPlaying = item;
              var previous = getPreviousItem();
              var next = getNextItem();
              talkify.messageHub.publish(
                player.correlationId + ".playlist.playing",
                { isFirst: !previous, isLast: !next }
              );
            ...
            function getNextChunck(text, safeMaxQuerystringLength) {
              ...
              var breakAt = text
                .substr(0, safeMaxQuerystringLength)
                .lastIndexOf(".");
              breakAt =
                breakAt > -1
                  ? breakAt
                  : text.substr(0, safeMaxQuerystringLength).lastIndexOf("。");
            ...
            function extractTables() {
              ...
              return Array.from(
                document.querySelectorAll(".talkify-tts-table")
              );
            }
            function initialize() {
              reset();
              ...
              if (!settings.domElements) {
                settings.domElements = textextractor.extract(
              ...
              for (var t = 0; t < tables.length; t++) {
                var cells = Array.from(
                  tables[t].querySelectorAll(".talkify-tts-tablecell")
                );
                ...
                for (var j = 0; j < playlist.queue.length; j++) {
                  ...
                  if (j > 0) {
                    var isSameAsPrevious =
                      item.element === playlist.queue[j - 1].element;
                    if (isSameAsPrevious) {
                      continue;
                    }
                  }
              ...
              talkify.messageHub.publish(
                player.correlationId + ".playlist.loaded"
              );
              if (settings.useTextInteraction) {
                talkify.messageHub.publish(
                  player.correlationId + ".playlist.textinteraction.enabled"
                );
              } else {
                talkify.messageHub.publish(
                  player.correlationId + ".playlist.textinteraction.disabled"
                );
              }
            }
            function getTextOfElement(element) {
              var clone = element.cloneNode(true);
              var matches = clone.querySelectorAll(
                '[data-talkify-read-as-lowercase="true"]'
              );
              if (
                matches.length === 0 &&
                clone.getAttribute("data-talkify-read-as-lowercase") === "true"
              ) {
                matches.push(clone);
              }
            ...
            function convertToSsml(element) {
              ...
              for (var key in ssmlMappings) {
                ...
                var startTagMatches =
                  ssml.match(new RegExp("<" + key + "+(>|.*?[^?]>)", "gi")) ||
                  [];
                for (var j = 0; j < startTagMatches.length; j++) {
                  if (
                    startTagMatches[j] !== "<" + key + ">" &&
                    startTagMatches[j].indexOf("<" + key + " ") !== 0
                  ) {
                    continue;
                  }
            ...
            function getNextItem() {
              var currentQueuePosition = playlist.queue.indexOf(
            ...
            function playFromBeginning() {
              ...
              var text =
                playlist.refrenceText.length <= 1e3
                  ? playlist.refrenceText
                  : playlist.refrenceText.substr(0, 1e3);
              talkify.http
                .get(
                  talkify.config.remoteService.languageBaseUrl +
                    "/detect?text=" +
                    text
                )
                .then(function (data) {
              ...
              function onComplete(refLang) {
                playlist.referenceLanguage = {
                  Culture: refLang.Cultures[0],
                  Language: refLang.Language,
                };
            ...
            function insertElement(element) {
              ...
              for (var j = 0; j < playlist.queue.length; j++) {
                var item = playlist.queue[j];
                var isSelectionAfterQueueItem =
                  element.compareDocumentPosition(item.element) ==
                  documentPositionFollowing;
            ...
            function removeEventListeners(eventType, element) {
              ...
              for (
                var i = 0;
                i < element.trackedEvents[eventType].length;
                i++
              ) {
                element.removeEventListener(
                  eventType,
                  element.trackedEvents[eventType][i]
                );
              }
            }
            ...
            return {
              ...
              setPlayer: function (p) {
                ...
                talkify.messageHub.unsubscribe(
                  "playlist",
                  player.correlationId + ".player.tts.unplayable"
                );
                talkify.messageHub.unsubscribe(
                  "playlist",
                  player.correlationId +
            ...
            begin: function () {
              ...
              return {
                ...
                subscribeTo: function (events) {
                  ...
                  s.events.onVoiceCommandListeningStarted =
                    events.onVoiceCommandListeningStarted || function () {};
                  s.events.onVoiceCommandListeningEnded =
                    events.onVoiceCommandListeningEnded || function () {};
                  return this;
                },
                build: function () {
                  if (!isSupported()) {
                    throw new Error(
                      "Not supported. The browser needs to support mp3 or wav HTML5 Audio."
                    );
                  }
                  if (!p) {
                    throw new Error(
                      "A player must be provided. Please use the 'usingPlayer' method to provide one."
                    );
                  }
                  s.events.onEnded = s.events.onEnded || function () {};
                  s.events.onVoiceCommandListeningStarted =
                    s.events.onVoiceCommandListeningStarted || function () {};
                  s.events.onVoiceCommandListeningEnded =
                    s.events.onVoiceCommandListeningEnded || function () {};
      ...
      function (require, module, exports) {
        ...
        talkify.SpeechCommands = function (speechCommandConfig) {
          ...
          recognition.onresult = function (event) {
            ...
            var matchingCommandName = evaluate(
              transcript,
              speechCommandConfig.commands
            );
            if (
              speechCommandConfig.commands[matchingCommandName] ===
              speechCommandConfig.commands.playPause
            ) {
              onPlayPauseCallback();
            } else if (
              speechCommandConfig.commands[matchingCommandName] ===
              speechCommandConfig.commands.next
            ) {
              onNextCallback();
            } else if (
              speechCommandConfig.commands[matchingCommandName] ===
              speechCommandConfig.commands.previous
            ) {
              onPreviousCallback();
            }
          };
          ...
          function evaluate(transcript, commands) {
            ...
            if (possibleMatches.length > 0) {
              ...
              for (var j = 0; j < possibleMatches.length; j++) {
                var temp = Math.max.apply(
                  Math,
                  speechCommandConfig.commands[possibleMatches[j]].map(
                    function (phrase) {
      ...
      function (require, module, exports) {
        ...
        talkify.selectionActivator = (function () {
          ...
          function getElementsInSelection() {
            ...
            var nodes = getNodesInSelection(
              currentContext.range.commonAncestorContainer,
              currentContext.leftToRight
            );
            return nodes;
          }
          function createItemsFromNodes(nodes) {
            ...
            if (nodes.length === 1) {
              return [
                surroundNode(
                  nodes[0],
                  currentContext.range.startOffset,
                  currentContext.range.endOffset
                ),
              ];
            }
            for (var i = 0; i < nodes.length; i++) {
              if (i === 0) {
                if (currentContext.leftToRight) {
                  items.push(
                    surroundNode(
                      nodes[i],
                      currentContext.anchorOffset,
                      currentContext.anchorNode.textContent.length
                    )
                  );
                } else {
                  items.push(
                    surroundNode(
                      nodes[i],
                      currentContext.focusOffset,
                      currentContext.focusNode.textContent.length
                    )
                  );
                }
                continue;
              ...
              if (i === nodes.length - 1) {
                if (currentContext.leftToRight) {
                  items.push(
                    surroundNode(nodes[i], 0, currentContext.focusOffset)
                  );
                } else {
                  items.push(
                    surroundNode(nodes[i], 0, currentContext.anchorOffset)
                  );
                }
                continue;
              }
            ...
            for (var i = 0; i < element.childNodes.length; i++) {
              ...
              var tagName =
                node.tagName != undefined
                  ...
                  : undefined;
              if (
                forbiddenElementsString.indexOf(tagName) !== -1 ||
                settings.exclude.indexOf(node) !== -1
              ) {
                continue;
              }
              ...
              var group = inlineGroups.filter(function (x) {
                return x.indexOf(node) > -1;
              })[0];
              if (group) {
                nodes.push(group);
          ...
          function getInlineGroups(nodes) {
            ...
            for (var i = 0; i < nodes.length; i++) {
              ...
              var isBlockElement =
                node.nodeType === 1 &&
                inlineElements.indexOf(node.tagName.toLowerCase()) === -1;
              if (isBlockElement) {
                continue;
              }
              if (validNodeTypes.indexOf(node.nodeType) === -1) {
          ...
          function surroundNode(node, startOffset, endOffset) {
            ...
            if (Array.isArray(node)) {
              ...
              return { newNode: newParent, originalNode: originalNodes };
            }
            var original = node.cloneNode(true);
            if (node.nodeType === 1) {
              node.classList.add("talkify-selected-text");
              return { newNode: node, originalNode: original };
            }
            ...
            return { originalNode: original, newNode: newParent };
          }
          function deactivate() {
            activated = false;
          ...
          function activate() {
            ...
            if (
              settings.exclude &&
              NodeList.prototype.isPrototypeOf(settings.exclude)
            ) {
          ...
          function onMouseUp(e) {
            ...
            if (
              ...
              if (
                currentContext.anchorNode === currentSelection.anchorNode &&
                currentContext.focusNode === currentSelection.focusNode
              ) {
                return;
              }
              if (
                activatorHtml &&
                (activatorHtml.contains(currentSelection.focusNode) ||
                  activatorHtml.contains(currentSelection.anchorNode))
              ) {
                return;
              }
          ...
          function orchestrateAfterSelection() {
            ...
            var position = currentContext.anchorNode.compareDocumentPosition(
              currentContext.focusNode
            );
            currentContext.leftToRight = !(
            ...
            renderActivator();
            activatorHtml.addEventListener(
              "click",
          ...
          function activateControlcenter() {
            ...
            currentContext.elements = createItemsFromNodes(
              currentContext.nodes
            );
            var elements = currentContext.elements.map(function (x) {
              return x.newNode;
            });
            ...
            player = new talkify.TtsPlayer({
              controlcenter: { name: "local", container: controlcenterHtml },
            });
            talkify.messageHub.subscribe(
              "text-selection-activator",
              player.correlationId + ".player.*.disposed",
              disposeControlCenter
            );
          ...
          function disposeControlCenter() {
            ...
            if (currentContext.range.commonAncestorContainer.nodeType !== 1) {
              ...
              if (element) {
                element.newNode.parentElement.replaceChild(
          ...
          function restoreDom() {
            ...
            for (var i = 0; i < elements.length; i++) {
              ...
              if (Array.isArray(originalNode)) {
                ...
                currentNode.parentElement.replaceChild(
                  originalNode,
                  currentNode
                );
              }
              var candidatesForEvents = Array.isArray(originalNode)
                ? originalNode
                    ...
                    .flat()
                : [originalNode].concat(
                    originalNode.getElementsByTagName
                      ? Array.from(originalNode.getElementsByTagName("*"))
                      : []
                  );
              var events = candidatesForEvents
                .map(function (x) {
              ...
              for (var j = 0; j < candidatesForEvents.length; j++) {
                ...
                var eventsToApply = events
                  .filter(function (x) {
                    return element.isEqualNode(x.node);
                  })
                  .map(function (x) {
                    return x.events;
                  })
          ...
          function removeActivator() {
            ...
            activatorHtml.removeEventListener(
              "click",
              activateControlcenter,
              false
            );
          ...
          function renderActivator() {
            ...
            div.innerHTML =
              '<div class="talkify-popup-activator">                            <button title="Talkify">                                <i class="fas fa-play"></i>' +
              settings.buttonText +
              "</button>                        </div>";
            activatorHtml = div;
        ...
        talkify.domExtensions = {
          recordEvents: (function () {
            ...
            function initialize() {
              ...
              Node.prototype._addEventListener =
            ...
            function getEvents(node) {
              ...
              return { node: result[0].node, events: result };
            }
            return { getEvents: getEvents, begin: initialize };
          })(),
        };
      },
      {},
      ...
      function (require, module, exports) {
        ...
        talkify.textextractor = function () {
          ...
          function isValidForGrouping(node) {
            ...
            return (
              (isTextNode && textLength >= 2) ||
              (!isForbidden(node) && elementIsInlineElement(node))
            );
          }
          ...
          function evaluate(nodes) {
            ...
            for (var i = 0; i < nodes.length; i++) {
              ...
              if (
                getForbiddenElements().indexOf(
                  getSafeTagName(node).toLowerCase()
                ) !== -1
              ) {
                var forcedElement = (
              ...
              if (
                getSafeTagName(node).toLowerCase() === "a" &&
                !isValidAnchor(node)
              ) {
                continue;
              }
              ...
              if (connectedElements.length > 1) {
                ...
                var isAboveThreshold =
                  getStrippedText(wrapping.innerText).length >= 20;
                if (isAboveThreshold) {
                  ...
                  for (var j = 0; j < connectedElements.length; j++) {
                    ...
                    connectedElements[j].parentNode.removeChild(
                      connectedElements[j]
                    );
                  }
          ...
          function extract(rootSelector, exclusions) {
            ...
            validElements = [];
            var topLevelElements = document.querySelectorAll(
              rootSelector + " > " + generateExcludesFromForbiddenElements()
            );
          ...
          function elementIsParagraphOrHeader(element) {
            ...
            return (
              ["p", "h1", "h2", "h3", "h4", "h5", "h6"].indexOf(
                getSafeTagName(element).toLowerCase()
              ) != -1
            );
          }
          function elementIsInlineElement(element) {
            ...
            return (
              inlineElements.indexOf(getSafeTagName(element).toLowerCase()) !=
              -1
            );
          }
          ...
          function getChildren(n, skipMe) {
            ...
            for (; n; n = n.nextSibling)
              if (n.nodeType == 1 && n != skipMe && !isForbidden(n)) r.push(n);
            return r;
          }
          ...
          function isForbiddenByClass(node) {
            ...
            return !!forbiddenClasses.find(function (x) {
              return node.closest("." + x);
            });
          }
        ...
        talkify.wordHighlighter = function (correlationId) {
          ...
          talkify.messageHub.subscribe(
            ...
            function (timeInfo) {
              ...
              var time = timeInfo.currentTime * 1e3;
              var currentPos = 0;
              ...
              for (var i = 0; i < currentPositions.length; i++) {
                ...
                if (
                  time >= position &&
                  time <= currentPositions[i + 1].Position
                ) {
                  currentPos = i;
                  break;
                }
            ...
            if (enhancedView && currentControlcenterPosition) {
              ...
              var hasOverlay =
                ...
                enhancedViewPosition.y <=
                  currentControlcenterPosition.y +
                    currentControlcenterPosition.height;
              hasOverlay =
                hasOverlay ||
              ...
              if (hasOverlay) {
                enhancedView.style.bottom =
                  currentControlcenterPosition.height + "px";
              } else {
                enhancedView.style.bottom = "";
              }
            }
          ...
          function resetCurrentItem() {
            if (currentItem) {
              currentItem.element.innerHTML =
                currentItem.originalElement.innerHTML;
            }
          }
          function setPosition(message) {
            var diff = 0;
            var timeInMs = message.time * 1e3;
            var nextPosition = 0;
